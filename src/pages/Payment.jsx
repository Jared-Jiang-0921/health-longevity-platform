    ...
    <div className="page-content">
      ...
      <details className="payment-tier-desc">
        ...
        <ul>
          ...
          <li><strong>标准会员</strong>：在普通会员基础上增加长寿知识技能大部分、转化应用机遇全部、治未病全部，以及 AI 长寿师下的健康风险评估（China-PAR、糖尿病、高血压、痴呆、帕金森相对风险、骨质疏松、肌少症、生活方式）；「自我健康促进咨询」每日 20 万 token。专业健康长寿咨询需高级会员。</li>
